  ...
  return (
    <div className="min-h-screen w-full bg-[#0B0F19] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-[#131927]/90 backdrop-blur-xl border border-slate-800/80 rounded-3xl shadow-2xl p-6 sm:p-8 relative z-10 space-y-6">
        ...
        {/* Receptionist POS Workspace Badge */}
        <div className="bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-amber-500/10 border border-amber-500/30 p-3.5 rounded-2xl flex items-center justify-center gap-2.5 shadow-inner">
          ...
          <span className="text-xs font-extrabold text-amber-300 tracking-wider uppercase">Receptionist POS Workspace</span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5 animate-fade-in">
            ...
            >
            {branchesLoading ? (
              <option value="" disabled>⏳ Connecting to server… please wait</option>
            ) : branches.length === 0 ? (
              <option value="" disabled>❌ No branches found — check internet connection</option>
            ) : (
              branches.map((b) => (
